...
public final class ArabicAnalyzer extends StopwordAnalyzerBase {
  ...
  protected TokenStreamComponents createComponents(String fieldName) {
    ...
    ArabicStemFilter araStemFilter = new ArabicStemFilter(result);
    araStemFilter.ArabicStemFilterSet(farasaSegmenter);
    //araStemFilter.farasaSegmenter = farasaSegmenter;
    return new TokenStreamComponents(source, araStemFilter);
